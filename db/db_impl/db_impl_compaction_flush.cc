...
Status DBImpl::CompactFilesImpl(
  ...
  CompactionJob compaction_job(
      ...
      GetDataDir(c->column_family_data(), c->start_level_path_id()),
      GetDataDir(c->column_family_data(), c->latter_level_path_id()),
