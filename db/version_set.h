...
class VersionStorageInfo {
 public:
  ...
  void PrepareForVersionAppend(ColumnFamilyData* cfd, const Version& version);
...
class Version {
 public:
  InternalIterator* NewIterForLevel(
      Arena* arena, const ReadOptions& read_options,
      const FileOptions& soptions, int level, bool allow_unprepared_value,
  ...
  void Get(DBImpl* db, const ReadOptions&, const LookupKey& key, PinnableSlice* value,
 ...
 private:
  ...
  void HandleFound(const ReadOptions& read_options, GetContext& get_context,
                   int hit_level, PinnableSlice* value,
